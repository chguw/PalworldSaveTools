...
NEW_TRANSLATIONS = {'inventory.clear_btn': 'Clear', 'inventory.equip_clear_btn': 'Clear', 'inventory.clear_confirm_title': 'Clear Inventory', 'inventory.clear_confirm_msg': 'Remove all items from inventory and key items?', 'inventory.equip_clear_title': 'Clear Equipment', 'inventory.equip_clear_msg': 'Remove all equipment from weapon, armor, and food slots?'}
OLD_KEYS = []
