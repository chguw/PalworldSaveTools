...
NEW_TRANSLATIONS = {'edit_pals.ctx.learnt_skills': 'Learnt Skills', 'edit_pals.ctx.bulk_sync_passives': 'Bulk Sync Passives', 'edit_pals.bulk_sync_title': 'Bulk Sync Passives - {name}', 'edit_pals.bulk_sync_found': 'Found {count} {name}', 'edit_pals.bulk_sync_success': 'Updated {count} {name} passives!', 'edit_pals.learnt_skills_title': 'Learnt Skills', 'edit_pals.learnt_skills_count': '{count} skills learnt', 'edit_pals.confirm_remove_skill': 'Remove {name} from learnt moves?', 'edit_pals.learnt_skills_removed': '{name} removed from learnt moves.'}
