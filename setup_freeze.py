...
_BUILD_PACKAGES = ['subprocess', 'pathlib', 'shutil', 'cityhash', 'json', 'uuid', 'time', 'datetime', 'struct', 'enum', 'collections', 'itertools', 'math', 'zlib', 'gzip', 'zipfile', 'threading', 'multiprocessing', 'io', 'base64', 'binascii', 'hashlib', 'hmac', 'secrets', 'ssl', 'socket', 'urllib', 'http', 'mimetypes', 'tempfile', 'glob', 'fnmatch', 'argparse', 'configparser', 'logging', 'traceback', 'string', 'random', 're', 'copy', 'ctypes', 'gc', 'importlib', 'ooz', 'pickle', 'platform', 'PySide6.QtCore', 'PySide6.QtGui', 'PySide6.QtWidgets', 'nerdfont', 'concurrent.futures', 'pydantic', 'loguru', 'palworld_toolsets', 'palworld_xgp_import']
_BUILD_EXCLUDES = ['pandas', 'numpy', 'email', 'unittest', 'unittest.mock', 'test', 'pdb', 'tkinter.test', 'lib2to3', 'distutils', 'setuptools', 'pip', 'wheel', 'venv', 'ensurepip', 'msgpack', 'palworld_save_tools.pyooz'] + _PYSIDE6_EXCLUDES
build_exe_options = {'packages': _BUILD_PACKAGES, 'excludes': _BUILD_EXCLUDES, 'include_files': [('readme.md', 'readme.md'), ('license', 'license'), ('resources/', 'resources/'), ('src/data/', 'src/data/'), ('src/games.json', 'games.json')], 'zip_include_packages': [], 'zip_exclude_packages': ['*'], 'build_exe': 'PST_standalone', 'optimize': 0, 'silent': True}
ps6_a = find_pyside6_assets()
if ps6_a:
    build_exe_options['include_files'].extend(ps6_a)
setup(name='PalworldSaveTools', version="1.1.89", options={'build_exe': build_exe_options}, executables=[Executable('src/palworld_aio/main.py', base='gui', target_name='PalworldSaveTools.exe', icon='resources/pal.ico')])