...
class PalInfoWidget(QFrame):
    ...
    def _build_body(self, parent):
        ...
        self.trust_level_lbl.setAlignment(Qt.AlignRight | Qt.AlignVCenter)
        self.trust_level_lbl.setStyleSheet('font-size: 9px; font-weight: 700; color: #F472B6; background: transparent; border: none; padding: 0;')
        trust_row.addWidget(self.trust_level_lbl)
    ...
    def _update_display(self, pal_data):
        try:
            ...
            self.trust_level_lbl.setText(str(trust_rank))
