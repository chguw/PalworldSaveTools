...
from palworld_aio.ui.styles import DIALOG_STYLE, PICKER_BG_STYLE, PICKER_SEARCH_STYLE, PICKER_LIST_STYLE, INPUT_DIALOG_STYLE, TOOLTIP_STYLE
...
class PalInfoWidget(QFrame):
    ...
    def _build_header(self, parent):
        ...
        lv_layout.setContentsMargins(3, 4, 3, 3)
    ...
    def _build_body(self, parent):
        ...
        self.trust_bar.setFixedHeight(12)
        ...
        stamina_icon = QLabel('⚡')
        stamina_icon.setFixedSize(12, 12)
        ...
        self.stamina_bar.setFixedHeight(12)
        ...
        right_layout.addLayout(stamina_row)
        hp_row = QHBoxLayout()
        hp_row.setSpacing(0)
        hp_icon = QLabel('♥')
        hp_icon.setFixedSize(12, 12)
        ...
        hunger_icon = QLabel('⚬')
        hunger_icon.setFixedSize(12, 12)
        ...
        self.san_bar.setFixedHeight(12)
    ...
    def _build_skills(self, parent):
        ...
        skill_box.setSizePolicy(QSizePolicy.Expanding, QSizePolicy.Expanding)
        ...
        self.partner_frame.setSizePolicy(QSizePolicy.Expanding, QSizePolicy.Expanding)
        sp2 = self.partner_frame.sizePolicy()
        sp2.setRetainSizeWhenHidden(True)
        self.partner_frame.setSizePolicy(sp2)
        ...
        partner_layout.addWidget(self.partner_desc_lbl, 1)

        self.active_skills_frame = QFrame()
        self.active_skills_frame.setObjectName('activeSkillsBox')
        self.active_skills_frame.setSizePolicy(QSizePolicy.Expanding, QSizePolicy.Expanding)
        sp = self.active_skills_frame.sizePolicy()
        sp.setRetainSizeWhenHidden(True)
        self.active_skills_frame.setSizePolicy(sp)
        ...
        self.active_skills_list.setSpacing(0)
        as_layout.addLayout(self.active_skills_list, 1)

        sb_layout.addWidget(self.active_skills_frame, 1)
        sb_layout.addWidget(self.partner_frame, 1)
        ...
        pg_layout.setRowStretch(0, 1)
        pg_layout.setRowStretch(1, 1)
        ...
        sb_layout.addWidget(pg, 1)

        parent.addWidget(skill_box, 1)
    def _update_display(self, pal_data):
        try:
            ...
            for i in range(3):
                ...
                self.active_skills_list.addWidget(slot, 1)
